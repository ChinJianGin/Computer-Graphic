...
ShootingGame::ShootingGame(int width, int height, const char* title, bool screen, bool vsync)
{
    ...
    m_Camera = CreateRef<OrthoCamera>(-2.7f, 2.7f, -4.8f, 4.8f);
    ...
    // m_Circle = m_Factory->ShapeCreator<Circle>();
...
***/
        ...
        // CustomSpace::Renderer::Submit(m_Circle->GetVertexData()->m_Shader, m_Circle);
        // m_Circle->GetVertexData()->m_Shader->SetInt("Texture2", 1);
       ///----------------------------------------
        ...
        // m_Circle->SetPosition(m_Transform2 - glm::vec3(-1, -1, 0));
